 ...
 * -------------------------------------------------------------
 */
krait_void printScannerError(krait_char* fmt, ...);
krait_void displayScanner(BufferReader* ptrBuffer);
krait_long getScannerFilesize(krait_char* fname);
